...
def rainfall_monthly_coverage_viz(monthly_dir, output_dir):
    ...
    plt.savefig(os.path.join(output_dir, 'rainfall_monthly_coverage_heatmap.png'))
    plt.show()

def main():
    SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
    PROJECT_ROOT = os.path.abspath(os.path.join(SCRIPT_DIR, '../..'))
    MONTHLY_DIR = os.path.join(PROJECT_ROOT, 'Process_Raw_Rainfall_Data', 'output', 'monthly_rainfall')
