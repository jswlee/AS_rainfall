...
def main():
    ...
    def objective(trial):
        hp = {
            "climate_units": metadata["climate_shape"][0] * trial.suggest_int("climate_multiplier", 8, 32),
            "dem_units": trial.suggest_int("dem_units", 32, 96, step=32),
            "month_units": trial.suggest_int("month_units", 16, 64, step=16),
            "hidden_units": trial.suggest_int("hidden_units", 192, 512, step=64),
