...
def main():
    ...
    parser.add_argument('--input_dir', type=str, default='raw_data/AS_RF_USGS_WRCC',
                        help='Directory containing raw rainfall CSV files')
    parser.add_argument('--output_dir', type=str, default='processed_data/mon_rainfall_new',
