...
CONFIG = {
    ...
    'climate_data_path': os.path.join(PROJECT_ROOT, 'processed_data/climate_var_3x3_grid.nc'),
    'raw_climate_dir': os.path.join(PROJECT_ROOT, 'raw_data/climate_variables'),
    'rainfall_dir': os.path.join(PROJECT_ROOT, 'processed_data/mon_rainfall'),
    'station_locations_path': os.path.join(PROJECT_ROOT, 'raw_data/AS_raingages/as_raingage_list2.csv'),
    'output_dir': os.path.join(PROJECT_ROOT, 'pipeline_processed_data'),
